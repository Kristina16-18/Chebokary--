...
def name_reg():
    global start_input_for_name, start_input_for_password, start_input_for_repeat_password, user_name, user_password,\
         user_repeat_password, text_tick_name, text_tick_password, text_tick_repeat_password, name_error
...
def password_reg():
    global start_input_for_name, start_input_for_password, start_input_for_repeat_password, user_name, user_password,\
         user_repeat_password, text_tick_name, text_tick_password, text_tick_repeat_password, name_error, password_error  
...
def password_repeat_reg():
    global start_input_for_name, start_input_for_password, start_input_for_repeat_password, user_name, user_password,\
         user_repeat_password, text_tick_name, text_tick_password, text_tick_repeat_password, repeat_password_error, name_error, password_error
...
def after_reg():
    ...
    login.user.password = user_password
    login.user.score = 0
    login.user_name, user_password, user_repeat_password = '', '', ''
